...
// @desc deletePost user
// @access Public

router.delete('/:id', verifyToken, async (req, res) => {
    try {
        const postDeleteCondition = { _is: req.params.id, user: req.userId }
        const deletPost = await Post.findOneAndDelete(postDeleteCondition)
        ...
        if (!deletPost)
            return res
                ...
                res.json({success: true, this.post: deletPost})
    } catch (error) {
